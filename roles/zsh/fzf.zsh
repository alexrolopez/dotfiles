...
export FZF_CTRL_T_PREVIEW_COMMAND="file -biL {} | grep 'charset=binary' | grep -v 'inode/directory' > /dev/null && (file -bL {} ; file -biL {}) || (bat --style=numbers,changes --wrap=never --color=always {} || cat {} || tree -alC --noreport {})"
